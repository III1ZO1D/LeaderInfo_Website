        ...
        <ScrollOrchestrator className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div data-animate>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              Начните путь к{' '}
              <span className="text-gradient-primary">эффективности</span>
            </h2>

            <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-lg">
              Оставьте заявку — мы подберём справочную систему под задачи вашей
              отрасли и покажем результат на демо.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3">
              {[
                ...
                'Результат видно с первого месяца',
